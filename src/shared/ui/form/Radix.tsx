...
/**
 * Eine erweiterte Checkbox mit Radix UI für bessere Accessibility.
 * Optimiert für React 19 Performance.
 */
export const FormCheckboxRadix = memo(
...
FormCheckboxRadix.displayName = 'FormCheckboxRadix';
...
/**
 * Ein erweitertes Select-Dropdown mit Radix UI für custom Styling.
 * Optimiert für React 19 Performance.
 */
export const FormSelectRadix = memo(
  <TFieldValues extends FieldValues = FieldValues>({
    name,
    label,
    description,
...
FormSelectRadix.displayName = 'FormSelectRadix';
