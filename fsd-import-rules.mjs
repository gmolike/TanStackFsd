...
export const appLayerRules = {
  ...
  export const widgetsLayerRules = {
  ...
  export const featuresLayerRules = {
  ...
  export const entitiesLayerRules = {
  ...
  export const generalLayerRules = {
    files: ['**/*.{js,jsx,ts,tsx}'],
    rules: {
        ...
        'error',
        {
          patterns: [
            // Prevent importing from higher layers
            {
              ...
              message: 'Imports from the app layer are not allowed except within the app layer itself.',
            },
            {
              group: [
                '^(~/pages|pages)(/.*)?$',
